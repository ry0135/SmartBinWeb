...
public class ManageController {
    ...
    @GetMapping("/batch-doing")
    public String taskdoing(Model model) {
        List<Bin> bins = binService.getAllBins();
    ...
    @GetMapping("/manage/bin/edit/{id}")
    public String editBinForm(@PathVariable("id") int id, Model model) {
    ...
    @PostMapping("/manage/bin/update")
    public String updateBin(@ModelAttribute Bin bin) {
        binService.saveOrUpdateBin(bin);
        return "redirect:/bins";
    }
    @DeleteMapping("/manage/bin/delete/{id}")
    @ResponseBody
    public String deleteBin(@PathVariable("id") int id) {
        try {
