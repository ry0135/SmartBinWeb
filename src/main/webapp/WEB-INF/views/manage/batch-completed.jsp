...
<html>
<head>
  <title>Nhiệm vụ đã hoàn thành</title>
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <div class="btn-toolbar mb-2 mb-md-0">
          <button class="btn btn-sm btn-outline-success" onclick="exportCompletedTasks()">
      ...
      <div class="card">
        ...
        <div class="card-body">
                    ...
                    <div class="col-md-8">
                      <div class="d-flex justify-content-between align-items-start mb-2">
                        ...
                        <div>
                          ...
                          <span class="badge completed-badge">ĐÃ HOÀN THÀNH</span>
                        </div>
                      </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-sm-6">
                            ...
                            <div class="mb-1">
                              ...
                              <small class="text-success">Hoàn thành 100%</small>
                            </div>
                          </div>
                        </div>
                      </div>
          ...
          <!-- Hiển thị Task đơn lẻ đã hoàn thành -->
          <c:if test="${not empty singleDoingTasks}">
            <div class="mt-4">
              <h5 class="mb-3">
                <i class="fas fa-list me-2"></i>
                Task đơn lẻ đã hoàn thành
              </h5>
          ...
          <c:if test="${empty completedTasksByBatch and empty singleDoingTasks}">
            <div class="text-center py-5" id="emptyState">
              ...
              <p class="text-muted">Chưa có nhiệm vụ nào được hoàn thành</p>
            </div>
          </c:if>
...
<script>
  ...
  function viewBatchDetail(batchId) {
    window.location.href = '${pageContext.request.contextPath}/tasks/batchCompleted/' + batchId;
  }
  ...
  function exportCompletedTasks() {
    alert('Xuất danh sách task đã hoàn thành\nChức năng đang được phát triển');
  }
</script>
</body>
</html>