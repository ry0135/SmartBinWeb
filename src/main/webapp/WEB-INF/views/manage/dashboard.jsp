    ...
    <div class="flex-grow-1" style="margin-left: 250px;">
        ...
        <div class="p-4">
            ...
            <div class="row g-4 mb-4">
                ...
                <!-- Tổng số thùng -->
                <div class="col-md-4">
                    <a href="${pageContext.request.contextPath}/bins" class="text-decoration-none text-dark">
                ...
                <!-- Cảnh báo -->
                <div class="col-md-4">
                    <a href="${pageContext.request.contextPath}/tasks/task-management" class="text-decoration-none text-dark">
                        <div class="card border-0 shadow-sm h-100">
                            <div class="card-body d-flex align-items-center">
                ...
                <!-- Báo cáo mới -->
                <div class="col-md-4">
                    <a href="${pageContext.request.contextPath}/reports" class="text-decoration-none text-dark">
                        <div class="card border-0 shadow-sm h-100">
                            <div class="card-body d-flex align-items-center">
