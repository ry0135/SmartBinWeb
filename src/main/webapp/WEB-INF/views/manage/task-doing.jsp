        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                <h1 class="h2 fw-bold text-primary">
                    <i class="fas fa-layer-group me-2"></i>Chi tiết Batch: ${batchId}
                </h1>
            ...
            <div class="card shadow-sm border-0">
                <div class="card-header bg-primary text-white py-3">
                    <h5 class="mb-0">
                        <i class="fas fa-tasks me-2"></i>Danh sách Task trong Batch
                    </h5>
                </div>
                                            ...
                                            <span class="badge ${task.priority == 1 ? 'bg-danger' : task.priority == 2 ? 'bg-warning text-dark' : 'bg-secondary'} px-3 py-2">
                                                <c:choose>
                                                    <c:when test="${task.priority == 1}">
                                                        <i class="fas fa-exclamation-circle me-1"></i>Cao
                                                    </c:when>
                                                    <c:when test="${task.priority == 2}">
                                                        <i class="fas fa-minus-circle me-1"></i>Trung bình
                                                    </c:when>
                                ...
                                <tr>
                                    <td colspan="6" class="text-center py-5">
                                        <div class="text-muted">
                                            ...
                                            <p class="mb-0">Không có task nào trong batch này</p>
                                        </div>
                                    </td>
                                </tr>
                            </c:if>
